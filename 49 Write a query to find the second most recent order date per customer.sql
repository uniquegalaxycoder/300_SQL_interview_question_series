"""
    Q. Write a query to find the second most recent order date per customer.
"""
...
select 
  *,
  row_number()over(partition by cust_id order by order_date desc) as order_no
from cte1
)
...
"""
  Output =>
      ...
      +---------+------------+----------------+--------------+
      | cust_id | order_date | food           | order_amount |
      +---------+------------+----------------+--------------+
      |     101 | 2025-12-05 | Butter Chicken |       450.00 |
      |     102 | 2025-12-15 | Pasta Alfredo  |       399.00 |
      |     103 | 2025-12-14 | Raita          |        60.00 |
      |     104 | 2025-12-23 | Veg Burger     |       180.00 |
      |     105 | 2025-12-27 | Filter Coffee  |        60.00 |
      +---------+------------+----------------+--------------+
  """
