...
(13, 'Hazel', 13, '2025-04-12',2, 63540),
(14, 'Luna', 15, '2024-07-21',11, 23600),
(15, 'Florence', 14, '2025-01-21',1, 45780)
;
...
-- Q.Write a query to show each employee salary along with the average salary of their department using a window function.

select 
  emp.*,
  deptartment.*,
  round(avg(salary)over(partition by department_name )) as dept_avg
from emp left join deptartment
