...
values 
(1, 'Joseph', '2025-01-01', 'New York City', 1234567890, 1),
(2, 'Robert', '2024-08-11', 'Los Angeles', 2345678901, 1),
(3, 'Kyle', '2024-11-23', 'Chicago', 1230987654, 0),
(4, 'Antonio', '2023-04-13', 'Houston', 1234098765, 1),
(5, 'Louis', '2024-09-21', 'Philadelphia', 9987654321, 1),
(6, 'Stephan', '2024-12-26', 'New York City', 4567890321, 1 ),
(7, 'Kyle', '2024-11-23', 'Chicago', 0987612345, 1) ;

insert into sales (sales_id, product_name, product_id, customer_id, sales_date, sales_amount, transaction_status)
values 
...
-- Q. Find the customers who have not made any purchase
...
where 
a.verfiy_status = True
and ( b.customer_id is null or b.sales_id is null )
